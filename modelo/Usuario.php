...
{   
   ...
   public static function buscar($query)
    ...
    {
        return Usuario::buscar("SELECT ide_usua,nombUsua, apeUsua, direccion, telefono, riesgos, eps, pension, rh, rol, usuario, telFamiliar FROM usuario WHERE estado= 1 order by 1 desc");
    }
